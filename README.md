...
> AI coding assistants make every endpoint async, use global variables instead of `Depends()`,
> generate Pydantic v1 decorators, and put all routes in a single file. This plugin enforces the
> patterns that make FastAPI production-ready.
...
- [python-best-practices](https://github.com/ofershap/python-best-practices) - Python 3.12+ type
  hints, Pydantic v2, uv, pathlib
